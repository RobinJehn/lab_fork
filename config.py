...
# scene placements
ROBOT_PLACEMENT = pin.XYZQUATToSE3(np.array([0.0, 0.0, 0.85, 0.0, 0.0, 0.0, 1.0]))
TABLE_PLACEMENT = pin.SE3(rotate("z", -np.pi / 2), np.array([0.8, 0.0, 0.0]))
OBSTACLE_PLACEMENT = pin.SE3(rotate("z", 0), np.array([0.43, -0.1, 0.94]))
CUBE_PLACEMENT = pin.SE3(rotate("z", 0.0), np.array([0.33, -0.3, 0.93]))
